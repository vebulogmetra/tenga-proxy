...
def decode_base64(data: str, url_safe: bool = True) -> Optional[str]:
    try:
        # Add padding
...
def detect_link_type(link: str) -> Optional[str]:
    ...
    if link_lower.startswith("vless://"):
        ...
        return "shadowsocks"
    elif link_lower.startswith(("socks://", "socks4://", "socks4a://", "socks5://")):
        return "socks"
    elif link_lower.startswith(("http://", "https://")):
        return "http"
    elif link_lower.startswith("tenga://"):
        return "tenga"
