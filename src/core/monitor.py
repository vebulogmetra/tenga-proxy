...
class ConnectionMonitor:
    ...
    def __init__(self, context: 'AppContext'):
        ...
        self._on_status_changed: Optional[Callable[[ConnectionStatus, ConnectionStatus], None]] = None
        
    def set_on_status_changed(self, callback: Optional[Callable[[ConnectionStatus, ConnectionStatus], None]]) -> None:
