...
class TrayIcon:
    ...
    def __init__(self, context: AppContext):
        ...
        self._on_select_profile: Callable[[int], None] | None = None
        self._on_add_profile: Callable[[], None] | None = None
        ...
        self._connect_item: Gtk.MenuItem | None = None
        self._status_item: Gtk.MenuItem | None = None
        self._profiles_menu: Gtk.Menu | None = None
