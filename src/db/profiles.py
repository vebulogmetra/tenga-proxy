...
class ProfileManager:
    ...
    def get_profile(self, profile_id: int) -> Optional[ProfileEntry]:
        """Get profile by ID."""
        return self._profiles.get(profile_id)
    
    def get_group(self, group_id: int) -> Optional[ProfileGroup]:
        """Get group by ID."""
    ...
    def parse_and_add_link(self, link: str, group_id: Optional[int] = None) -> Optional[ProfileEntry]:
    ...
    @staticmethod
    def parse_link(link: str) -> Optional['ProxyBean']:
        """Parse share link."""
        from src.fmt.protocols import (
            VLESSBean,
            TrojanBean,
